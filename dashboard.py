...
from strategy_panel import Strategy_Panel
...
class Dashboard(ttk.Frame):
    def __init__(self, parent, controller, show_settings, height, width):
        ...
        self.strategy_panel = Strategy_Panel(self, height=1*height/6, width=2*width/3)
        self.strategy_panel.grid(row=2, column=1, sticky="NSEW", columnspan=2)

        self.control_panel = Control_Panel(self, height=1*height/6, width=width)
        self.control_panel.grid(row=3, column=0, sticky="NSEW", columnspan=3)
